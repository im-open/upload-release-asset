...
var uploadUrl = core.getInput('upload-url', requiredArgOptions);
var assetPath = core.getInput('asset-path', requiredArgOptions);
var assetName = core.getInput('asset-name', requiredArgOptions);
var assetContentType = core.getInput('asset-content-type', requiredArgOptions);
